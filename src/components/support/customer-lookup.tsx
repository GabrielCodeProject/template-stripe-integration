...
const CustomerCard: React.FC<{
  ...
  const getSubscriptionBadge = (status: string) => {
    switch (status) {
      ...
      case 'past_due':
        return (
          <Badge variant="past_due" className="text-xs">
            Past Due
          </Badge>
        );
      case 'canceled':
    ...
    <Card className="card-shadow">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            <p className="currency-cad text-sm font-medium">
              ...
              {customer.recentOrders.slice(0, 3).map(order => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="currency-cad">
                      {formatCAD(order.amount)}
                    </span>
                    <Badge
                      variant={
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground max-w-md">
                  No customers match your search criteria. Try searching with a
                  different email, name, or customer ID.
                </p>
              </CardContent>
            </Card>
          )}
      ...
      {!hasSearched && !isSearching && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-muted-foreground max-w-md">
              Enter a customer's email, name, or ID to view their details,
